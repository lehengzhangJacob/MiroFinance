...
# 长时间 GEPA 进化用 nohup（终端/IDE 关闭也不中断）
./scripts/launch_evolve_nohup.sh ashare_prediction_protocol 3
tail -f logs/nohup_evolve/ashare_prediction_protocol_3iter.log
```
